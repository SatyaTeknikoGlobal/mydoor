        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div class="card mb-3">
            <div class="card-header">
              ...
              <?php if(CustomHelper::isAllowedSection('admins' , $roleId , $type='add')): ?>
              <span class="pull-right">
                  <a href="<?php echo e(route($routeName.'.admins.add', ['back_url'=>$BackUrl])); ?>" class="btn btn-primary btn-sm"><i class="fas fa-user-plus" aria-hidden="true"></i> Add New Admin</a>
              </span>
              <?php endif; ?>
            </div>
...
<script>
  ...
  var table = $('#dataTable').DataTable({
   ...
   processing: true,
   serverSide: true,
   ajax: '<?php echo e(route($routeName.'.admins.get_admins')); ?>',
   columns: [
   { data: 'id', name: 'id' },
...
function change_admins_status(admin_id){
  var status = $('#change_admins_status'+admin_id).val();
   ...
   var _token = '<?php echo e(csrf_token()); ?>';
            ...
            $.ajax({
                url: "<?php echo e(route($routeName.'.admins.change_admins_status')); ?>",
                type: "POST",
...
function change_admins_approve(admin_id){
  var approve = $('#change_admins_approve'+admin_id).val();
   ...
   var _token = '<?php echo e(csrf_token()); ?>';
            ...
            $.ajax({
                url: "<?php echo e(route($routeName.'.admins.change_admins_approve')); ?>",
                type: "POST",
...
function change_admins_role(admin_id){
  var role_id = $('#change_admins_role'+admin_id).val();
   ...
   var _token = '<?php echo e(csrf_token()); ?>';
            ...
            $.ajax({
                url: "<?php echo e(route($routeName.'.admins.change_admins_role')); ?>",
                type: "POST",
...
</script><?php /**PATH /home/appmantr/public_html/mydoor/resources/views/admin/admins/index.blade.php ENDPATH**/ ?>