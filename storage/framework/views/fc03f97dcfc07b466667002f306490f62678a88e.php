...
<script>
  ...
  var table = $('#dataTable').DataTable({
   ...
   serverSide: true,
    ...
    ajax: {
          url: '<?php echo e(route($routeName.'.complaints.get_complaints')); ?>',
          data: function (d) {
...
<script type="text/javascript">
  function get_textarea_value(id){
    ...
    $.ajax({
      url: "<?php echo e(route($routeName.'.complaints.remark_submit')); ?>",
      type: "POST",
  ...
  function change_complaint_status(com_id){
    ...
    $.ajax({
      url: "<?php echo e(route($routeName.'.complaints.change_complaint_status')); ?>",
      type: "POST",
...
<script type="text/javascript">
  $('#society').change(function() {
    ...
    $.ajax({
      url: "<?php echo e(route($routeName.'.get_blocks')); ?>",
      type: "POST",
  ...
  $('#blocks').change(function() {
    ...
    $.ajax({
      url: "<?php echo e(route($routeName.'.get_flats')); ?>",
      type: "POST",
...
</script><?php /**PATH /home/appmantr/public_html/mydoor/resources/views/admin/complaints/index.blade.php ENDPATH**/ ?>