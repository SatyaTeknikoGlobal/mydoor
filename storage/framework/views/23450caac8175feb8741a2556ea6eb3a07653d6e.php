      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-primary">
            <div class="card-header"><img class="logo-img" src="<?php echo e(asset('public/assets1/img/logo-xx.png')); ?>" alt="logo" width="{conf.logoWidth}" height="200" width="200"><span class="splash-description">MyDoor Society Admin Register</span></div>
            <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select name="society_id" class="form-control">
                      ...
                      <?php if(!empty($societies)){
                        foreach($societies as $soc){?>
                          <option value="<?php echo e($soc->id); ?>"><?php echo e($soc->name); ?></option>
                        <?php }}?>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group row login-submit">
                        ...
                        <div class="col-6"><a href="<?php echo e(url('admin/login')); ?>">Already Have An Account</a></div>
...
<?php /**PATH /home/appmantr/public_html/mydoor/resources/views/admin/register/index.blade.php ENDPATH**/ ?>