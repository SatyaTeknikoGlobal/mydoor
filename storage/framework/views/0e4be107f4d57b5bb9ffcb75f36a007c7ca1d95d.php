          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              <span class="pull-right">
                  <a href="<?php echo e(route($routeName.'.flatowners.add', ['back_url'=>$BackUrl])); ?>" class="btn btn-primary btn-sm"><i class="fas fa-user-plus" aria-hidden="true"></i> Add New Owner</a>
              </span>
              <?php endif; ?>
            </div>
...
<script>
  ...
  var table = $('#dataTable').DataTable({
   ...
   processing: true,
   serverSide: true,
   ajax: '<?php echo e(route($routeName.'.flatowners.get_flatowners')); ?>',
   columns: [
   { data: 'id', name: 'id' },
...
function change_flatowner_approve(user_id){
  var status = $('#change_flatowner_approve'+user_id).val();
   ...
   var _token = '<?php echo e(csrf_token()); ?>';
            ...
            $.ajax({
                url: "<?php echo e(route($routeName.'.flatowners.change_flatowner_approve')); ?>",
                type: "POST",
                data: {user_id:user_id, status:status},
                dataType:"JSON",
                headers:{'X-CSRF-TOKEN': _token},
...
</script><?php /**PATH /home/appmantr/public_html/mydoor/resources/views/admin/flatowners/index.blade.php ENDPATH**/ ?>