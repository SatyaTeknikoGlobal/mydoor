...
<div class="header bg-primary pb-6">
  ...
  <div class="col-lg-6 col-5 text-right">
      ...
      <a href="{{ route($routeName.'.posts.add')}}" class="btn btn-sm btn-neutral">New</a>
    <?php }?>
                ...
                foreach ($posts as $post){
                    ...
                    <tr>
                        ...
                        <td><?php if(!empty($post->image)){?>
                           <img src="{{ $post->image}}" style="width:70px;">
                         <?php }?>
                        ...
                        <td>
                            <a href="{{route($routeName.'.posts.edit', ['id'=>$post->id,'back_url'=>$BackUrl])}}" title="Edit"><i class="fas fa-edit"></i></a>
                        </td>
