            ...
            <ul>
                ...
                if(CustomHelper::isAllowedSection('roles' , $roleId , $type='show')){
                    if(CustomHelper::isAllowedSection('permission' , $roleId , $type='show')){
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                @if(CustomHelper::isAllowedSection('roles' , $roleId , $type='show'))
                                <li>
                                    <a href="{{ route($ADMIN_ROUTE_NAME.'.roles.index') }}" <?php if($url == $baseurl.'/admin/roles') echo "active"?> >Roles</a>
                                </li>
                                @endif
                                @if(CustomHelper::isAllowedSection('permission' , $roleId , $type='show'))
                                <li>
                                    <a href="{{ route($ADMIN_ROUTE_NAME.'.permission.index') }}" <?php if($url == $baseurl.'/admin/permission') echo "active"?>>Permissions</a>
                                </li>
                                @endif
                    ...
                    if(CustomHelper::isAllowedSection('admins' , $roleId , $type='show')){
                        ...
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.admins.index') }}" class="<?php if($url == $baseurl.'/admin/admins') echo "active"?>">
                    ...
                    if(CustomHelper::isAllowedSection('society' , $roleId , $type='show')){
                        ?>
                        @if(CustomHelper::isAllowedModule('society'))
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.society.index') }}" class="<?php if($url == $baseurl.'/admin/society') echo "active"?>">
                    ...
                    if(CustomHelper::isAllowedSection('blockes' , $roleId , $type='show')){
                        ?>
                        @if(CustomHelper::isAllowedModule('blockes'))
                        <li class="submenu">
                    ...
                    if(CustomHelper::isAllowedSection('flats' , $roleId , $type='show')){
                        ?>
                        @if(CustomHelper::isAllowedModule('flats'))
                        <li class="submenu">
                    ...
                    if(CustomHelper::isAllowedSection('flatowners' , $roleId , $type='show')){
                        ?>
                        @if(CustomHelper::isAllowedModule('flatowners'))
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.flatowners.index') }}" class="<?php if($url == $baseurl.'/admin/flatowners') echo "active"?>">
                                <i class="fas fa-user"></i>
                    ...
                    if(CustomHelper::isAllowedSection('services' , $roleId , $type='show')){
                        ?>
                        @if(CustomHelper::isAllowedModule('services'))
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.services.index') }}" class="<?php if($url == $baseurl.'/admin/services') echo "active"?>">
                    ...
                    if(CustomHelper::isAllowedSection('servicedetails' , $roleId , $type='show')){
                        ?>
                        @if(CustomHelper::isAllowedModule('servicedetails'))
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.servicedetails.index') }}" class="<?php if($url == $baseurl.'/admin/servicedetails') echo "active"?>">
                                <i class="fas fa-wrench"></i>
                    ...
                    if(CustomHelper::isAllowedSection('service_user' , $roleId , $type='show')){
                        ?>
                        @if(CustomHelper::isAllowedModule('service_user'))
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.service_user.index') }}" class="<?php if($url == $baseurl.'/admin/service_user') echo "active"?>">
                                <i class="fas fa-user"></i>
                    ...
                    if(CustomHelper::isAllowedSection('complaints' , $roleId , $type='show')){
                        ?>
                        @if(CustomHelper::isAllowedModule('complaints'))
                        <li class="submenu">
